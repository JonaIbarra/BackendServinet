...
from sqlalchemy import Column, DateTime, Float, ForeignKey, Integer, Numeric, SmallInteger, String, Text, func
...
class Servicios(Base):
    ...
    categoria_id = Column(Integer, ForeignKey("tbb_categorias.id"), nullable=False)
